...
class Person(object):
    ...
    def __str__(self):
        s = '\n'.join(['%s: '%v+str(eval('self.'+v)) for v in dir(self)\
                       if v[0:2]!='__' and len(eval('self.'+v))!=0])
        return s
...
sc = Scientist('Johan Bååth', address = 'Storgatan 12', discipline='Marine biology', phone='+46-18-524698')
...
pr = Professor('Johan Bååth', address = 'Storgatan 12', birthday = '1974-09-20', nationality='Swedish', job_phone='073-6783465', company='KTH', phone='+46-18-524698', discipline='Physics', science_type=['Experimental', 'Computational'])
